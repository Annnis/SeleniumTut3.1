...
//        wait.until(ExpectedConditions.elementToBeClickable(By.
//                xpath("//*[@id=\"to\"]")));
//        driver.findElement(By.xpath("/html/body/div[3]/div/form[1]/div[2]/div[4]/input")).sendKeys("MyTest");
...
//      //  В раскрывшемся письме проверить отправителя ("имя почтового ящика"), тему письма ("MyTest"), содержимое письма ("секретный адрес").
...
//        Assertions.assertEquals("MyTest", themeOfEmail);
...
//
//
//        //Убедиться, что пришло новое письмо с темой "Re: MyTest". Раскрыть его, кликнув по нему.String resendEmail = "Re: " + themeOfEmail; // 3.16
...
//        Assertions.assertEquals("Re: MyTest", toCheckRe);
...
//
//      //  Убедиться, что во входящих нет письма с темой "Re: MyTest"
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("delete")));
//        Assertions.assertFalse(driver.getPageSource().contains("Re: MyTest"));
//
//
//    }
//}
